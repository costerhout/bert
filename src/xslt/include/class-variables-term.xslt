...
@Last modified time: 2019-01-02T09:39:53-09:00
...
<xsl:stylesheet
    ...
    <xsl:variable name="nodeSemesterClassChooser" select="$nsSemestersAvailable/semester[title='Spring' and year='2019']"/>
